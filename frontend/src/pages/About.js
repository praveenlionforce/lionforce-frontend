...
function About() {
  ...
  return (
    <div className="pt-20">
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-black" data-testid="about-hero">
      ...
      {/* CEO Message Section */}
      <section className="py-20 bg-gradient-to-b from-gray-800 to-gray-900" data-testid="ceo-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 p-1 rounded-2xl">
                <div className="bg-gray-900 p-8 rounded-2xl">
                  ...
                  <div className="border-t border-gray-700 pt-4">
                    <p className="text-white font-bold">Praveen Kamalan</p>
      ...
      {/* Stats Section */}
      <section className="py-20 bg-gray-900" data-testid="about-stats">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-yellow-500 to-yellow-600" data-testid="about-cta">
