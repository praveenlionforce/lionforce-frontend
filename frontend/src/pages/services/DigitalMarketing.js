...
function DigitalMarketing() {
  const { content, global } = useSiteContent('digitalMarketing');
  ...
  return (
    <>
      ...
      <div className="overflow-hidden bg-white">
        {/* Hero Section */}
        <section className={`relative min-h-screen pt-20 bg-gradient-to-br ${hero.gradient || 'from-emerald-600 via-green-600 to-teal-600'}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full mb-8 border border-white/30">
                  ...
                  <span className="text-sm font-medium text-white">{hero.badge || 'Growth Marketing'}</span>
                </div>

                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6" data-testid="marketing-title">
                  {hero.title || 'Digital Marketing That Delivers ROI'}
                </h1>

                <p className="text-lg text-white/80 font-medium mb-4 tracking-wide">
                  {hero.tagline || 'Target Smart • Engage Deep • Grow Fast'}
                </p>

                <p className="text-xl text-white/90 leading-relaxed mb-8 max-w-lg">
                  {hero.subtitle || 'Data-driven marketing strategies that increase visibility, engagement, and conversions.'}
                </p>

                <div className="flex flex-wrap gap-3 mb-10">
                  {(hero.stats || ['500% average ROI', 'Full-funnel approach', 'Measurable results']).map((stat, i) => (
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link
                    to="/contact"
                    className="group inline-flex items-center justify-center gap-2 bg-white text-green-600 px-8 py-4 rounded-full font-bold text-lg hover:shadow-2xl transition-all duration-300 hover:scale-105"
                    data-testid="marketing-cta-primary"
                  >
                    {hero.primaryCTA || 'Get Marketing Strategy'}
              ...
              >
                <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl border border-white/20 shadow-2xl">
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      { icon: Search, label: 'SEO', value: 'Organic Growth' },
                      { icon: Share2, label: 'Social', value: 'Engagement' },
                      { icon: Target, label: 'PPC', value: 'Targeted Ads' },
                      { icon: Mail, label: 'Email', value: 'Nurture Leads' }
                    ].map((item, i) => (
                      <motion.div
                        key={i}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                Marketing <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">Services</span>
              </h2>
              ...
              {services.map((service, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative p-8 bg-white rounded-2xl border border-gray-200 hover:border-green-300 transition-all hover:shadow-xl h-full">
        ...
        {/* CTA Section */}
        <section className={`py-24 bg-gradient-to-r ${hero.gradient || 'from-emerald-600 via-green-600 to-teal-600'} relative overflow-hidden`}>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            >
              ...
              <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
                Let's create a marketing strategy that delivers measurable results. Get a free consultation.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center gap-2 bg-white text-green-600 px-10 py-5 rounded-full font-bold text-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 group"
                >
