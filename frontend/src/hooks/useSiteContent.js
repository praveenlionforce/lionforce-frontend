...
const defaultContent = {
  ...
  contact: {
    seo: {
      ...
      description: 'Contact Lionforce for custom eLearning, software development, or India expansion services. Get a free consultation within 24 hours. Call +91 96005 36354.',
      keywords: 'contact Lionforce, get quote, free consultation, eLearning quote, software development inquiry, India expansion contact',
      ogImage: '',
      canonicalUrl: ''
    },
    hero: {
  ...
  software: {
    seo: {
      ...
      description: 'Custom software development, AI/ML solutions, web & mobile apps, IoT. MVP in 8-12 weeks. 300+ apps built. Expert team with 13+ years experience.',
      keywords: 'software development, AI solutions, machine learning, web apps, mobile apps, IoT, custom software, MVP development, React, Python',
      ogImage: '',
      canonicalUrl: ''
    },
    hero: {
  ...
  uxui: {
    seo: {
      ...
      description: 'Professional UX/UI design services. User research, wireframing, prototyping, and beautiful interfaces that convert. 300+ projects delivered.',
      keywords: 'UX design, UI design, user experience, user interface, wireframing, prototyping, design systems, Figma, user research',
      ogImage: '',
      canonicalUrl: ''
    },
    hero: {
  ...
  digitalMarketing: {
    seo: {
      ...
      description: 'Data-driven digital marketing with 500% average ROI. SEO, PPC, social media, email marketing, and analytics. Measurable results.',
      keywords: 'digital marketing, SEO, PPC, social media marketing, content marketing, email marketing, Google Ads, analytics, lead generation',
      ogImage: '',
      canonicalUrl: ''
    },
    hero: {
